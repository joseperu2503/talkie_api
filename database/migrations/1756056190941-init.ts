...
export class Init1756056190941 implements MigrationInterface {
    name = 'Init1756056190941'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "verification_codes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "code" text NOT NULL, "expiration_time" TIMESTAMP NOT NULL, "attempts" integer NOT NULL DEFAULT '0', "verified" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_18741b6b8bf1680dbf5057421d7" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "chat_users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "unread_messages_count" integer NOT NULL DEFAULT '0', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "chat_id" uuid, "user_id" uuid, CONSTRAINT "PK_45f77b7b90225045d6bf7f13756" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "message_users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "delivered_at" TIMESTAMP, "read_at" TIMESTAMP, "message_id" uuid, CONSTRAINT "PK_5cd64c25bd52ad55f87b084ba63" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "messages" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "content" text, "sent_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "file_url" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "sender_id" uuid, "chat_id" uuid, CONSTRAINT "PK_18325f38ae6de43878487eff986" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "countries" ("id" SERIAL NOT NULL, "name" text NOT NULL, "flag" text NOT NULL, "code" text NOT NULL, "dialCode" text NOT NULL, "mask" text NOT NULL, CONSTRAINT "PK_b2d7006793e8697ab3ae2deff18" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "fcm_tokens" ("token" text NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "user_id" uuid, CONSTRAINT "PK_639c0f1d38d97d778122d4f2998" PRIMARY KEY ("token"))`);
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" text, "password" text NOT NULL, "name" text NOT NULL, "surname" text NOT NULL, "phone_country_id" integer, "phone" text, "photo" text, "is_connected" boolean NOT NULL DEFAULT false, "last_connection" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_a0bb90fab63c3dde8e48007708b" UNIQUE ("phone_country_id", "phone"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "contacts" ("alias" text, "owner_user_id" uuid NOT NULL, "target_user_id" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "chat_id" uuid, CONSTRAINT "PK_51b48f7a4f55a118ef12ec62752" PRIMARY KEY ("owner_user_id", "target_user_id"))`);
        await queryRunner.query(`CREATE TABLE "chats" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "users_id" uuid array NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "last_message" uuid, CONSTRAINT "REL_c79b05bd85c7981c0206e73da9" UNIQUE ("last_message"), CONSTRAINT "PK_0117647b3c4a4e5ff198aeb6206" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_408001d174eb8826dd8fdac7782" FOREIGN KEY ("phone_country_id") REFERENCES "countries"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "contacts" ADD CONSTRAINT "FK_2295cadcd8925e095ad3d7ccc1f" FOREIGN KEY ("owner_user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "contacts" ADD CONSTRAINT "FK_5e3aeae5c38a1a0ba6cf73c4573" FOREIGN KEY ("target_user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "contacts" DROP CONSTRAINT "FK_5e3aeae5c38a1a0ba6cf73c4573"`);
        await queryRunner.query(`ALTER TABLE "contacts" DROP CONSTRAINT "FK_2295cadcd8925e095ad3d7ccc1f"`);
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "FK_408001d174eb8826dd8fdac7782"`);
